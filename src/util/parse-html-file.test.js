const parseHtmlFile = require('./parse-html-file');
        ...
        JSDOM: {
            fromFile: () => {
                return new Promise((resolve, reject) => {
                    ...
                    resolve(new JSDOM('<!DOCTYPE html>\n' +
                        '<html lang="en">\n' +
                        '<head>\n' +
...
test('parse-html-file will successfully parse a zoom page', () => {
    parseHtmlFile('./test.htm').then((result) => {
